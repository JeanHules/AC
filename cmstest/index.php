...
<?php
    ...
    <img src='/pictures/{$value['ArtistImage']}' class='img1' />
    	    ...
    	    <div class='social'>
				<div class='facebook'>
					<a href='http://www.facebook.com/sharer.php?s=100&amp;p[url]=http://www.audiblecoffee.com/singles/m{$value['ID']}&amp;p[images][0]=http://www.audiblecoffee.com/img/logo1.jpg&amp;p[title]={$value['SharingTitle']}&amp;p[summary]=Served on Audible Coffee' target='_blank'>
				...
				<div class='twitter'>
					<a href='http://twitter.com/home/?status=@AudibleCoffee Served on Audible Coffee www.audiblecoffee.com/singles/m{$value['ID']}' 
