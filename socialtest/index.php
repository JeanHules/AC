...
<div id="awwwards"><a target="_blank" href="http://www.awwwards.com/web-design-awards/james-anderson-613"></a></div>
<div id="sharetabs">
...
//Whats your roast color change		
		...
		$("#thetextbox", this).css('display', 'block');
		}, function(){
		$("#thetextbox", this).css('display', 'none');
		});
