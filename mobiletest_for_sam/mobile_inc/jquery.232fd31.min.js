...
/**
 *Well Hello There! 
 *So you want to see what it takes to make the site?
 *Short answer, a bunch of plugins 
 *Long answer, email me at jeanhules@audiblecoffee.com and we can chat
 */
            ...
            this.each(function(idx){
                ...
                $player.jPlayer({
                    ready: function () {
                        ...
                        var el=$(this);
						el.jPlayer("option", "preload", "None");
...
this.src=img_src;}}
return this.each(function(){var $obj=$(this);var type=$obj[0].type;if($.inArray(type,opt._valid_types)==-1){throw new Error(type+' is not a valid input type. Must be radio or checkbox.');}
